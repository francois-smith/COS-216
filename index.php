...
<main>
    <section class="trending-news">
        ...
        <div class="trending-container">
            <div onclick="goToLink(this)" class="article1 general-article article">
                <span class="article_id"></span>
                <form class="rating_container">
                    <div class="rating-stars"  onclick="rate(event);">
            ...
            <div onclick="goToLink(this)" class="article2 general-article article">
                <span class="article_id"></span>
            ...
            <div onclick="goToLink(this)" class="article3 general-article article">
                <span class="article_id"></span>
                <form class="rating_container" onclick="rate(event)">
                    <div class="rating-stars">
            ...
            <div onclick="goToLink(this)" class="article4 general-article article">
                <span class="article_id"></span>
                <form class="rating_container" onclick="rate(event)">
                    <div class="rating-stars">
    ...
    <section class="latest-news">
        ...
        <div class="latest-container">
            <div onclick="goToLink(this)" class="main-article article">
                <span class="article_id"></span>
                <form class="rating_container" onclick="rate(event)">
                    <div class="rating-stars">
            ...
            <div onclick="goToLink(this)" class="sub-article1 sub-article-general article">
                <span class="article_id"></span>
                <a href="" class="link"></a>
                <form class="grid-article-image-sub-container">
            ...
            <div onclick="goToLink(this)" class="sub-article2 sub-article-general article">
                <span class="article_id"></span>
                <form class="rating_container" onclick="rate(event)">
                    <div class="rating-stars">
            ...
            <div onclick="goToLink(this)" class="sub-article3 sub-article-general article">
                <span class="article_id"></span>
                <form class="rating_container" onclick="rate(event)">
                    <div class="rating-stars">
            ...
            <div onclick="goToLink(this)" class="sub-article4 sub-article-general article">
                <span class="article_id"></span>
                <form class="rating_container" onclick="rate(event)">
                    <div class="rating-stars">
            ...
            <div onclick="goToLink(this)" class="sub-article5 sub-article-general article">
                <span class="article_id"></span>
                <form class="rating_container" onclick="rate(event)">
                    <div class="rating-stars">
